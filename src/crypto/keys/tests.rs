...
mod tests {
    ...
    fn test_ethereum_key_derivation() {
        ...
        let key_pair = derivation::derive_key_pair(&seed, KeyType::Ethereum, "m/44'/60'/0'/0/0").unwrap();
    ...
    fn test_solana_key_derivation() {
        ...
        let key_pair = derivation::derive_key_pair(&seed, KeyType::Solana, "m/44'/501'/0'/0'").unwrap();
    ...
    fn test_bitcoin_key_derivation() {
        ...
        let key_pair = derivation::derive_key_pair(&seed, KeyType::Bitcoin, "m/44'/0'/0'/0/0").unwrap();
